...
namespace SimpleCalendar.WPF.Services
{
    ...
    public class LocalConfigService
    {
        ...
        {
            int vl = (int)SystemParameters.VirtualScreenLeft;
            int vt = (int)SystemParameters.VirtualScreenTop;
